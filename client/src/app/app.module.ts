...
const routes: Routes = [
  ...
  { path: 'film/create', component: FilmCreateComponent, canActivate: [AuthGuardService] },
  { path: 'film/:id', component: FilmDetailsComponent, canActivate: [AuthGuardService] },
  { path: 'film/:id/edit', component: FilmUpdateComponent, canActivate: [AuthGuardService] },
